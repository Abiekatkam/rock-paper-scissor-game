...
const Mode2 = () => {
  ...
  const handleDeclareResult = (user, bot) => {
    ...
    if (user == bot) {
      ...
      (user == "scissor" && bot == "lizard") ||
      (user == "lizard" && bot == "paper") ||
      (user == "lizard" && bot == "spock") ||
      (user == "spock" && bot == "rock") ||
      (user == "spock" && bot == "scissor")
    ) {
    ...
    <div className="w-full h-fit flex lg:justify-center flex-col lg:p-4 gap-2">
      ...
      <div className="w-full h-fit flex lg:justify-center lg:flex-row flex-col-reverse lg:gap-6 gap-4">
        ...
        <div className="lg:w-[45%] flex flex-col gap-4">
          {/* Score Display */}
          <div className="w-full min-h-[590px] flex flex-col gap-3">
            <div className="w-full max-h-[590px] h-fit p-4 rounded-lg bg-gray-800 shadow-xl flex flex-col gap-3">
              ...
              {/* win stack */}
              <div
                className={` w-full max-h-[320px] h-fit ${
                  showHideRules ? "flex" : "hidden"
                } flex-col lg:gap-4 gap-5 overflow-y-scroll`}
              >
            ...
            <div
              ...
              } w-full max-h-[625px] flex flex-col items-center justify-center`}
            >
        ...
        <div className="lg:w-[55%] lg:p-4 flex items-center justify-center">
          ...
          >
            {/* Background Triangle */}
            <div className="absolute lg:top-[12%] lg:w-[420px] lg:h-[390px] w-[250px] flex items-center justify-center">
              <img src={BgPentagon} alt="rock" className="w-full h-full" />
            </div>

            {/* Scissor */}
            <div
              className="absolute lg:top-[3%] top-[10%] lg:w-[160px] lg:h-[160px] w-[100px] h-[100px] flex items-center justify-center rounded-full bg-slate-300 lg:border-[1rem] border-[0.8rem] border-yellow-400 cursor-pointer hover:scale-105 transition-all ease-in hover:border-yellow-600 hover:shadow-2xl z-10"
              data-target="scissor"
            ...
            {/* Paper */}
            <div
              className="absolute lg:top-[26%] top-[32%] lg:right-[15%] right-[2%] lg:w-[160px] lg:h-[160px] w-[100px] h-[100px] flex items-center justify-center rounded-full bg-slate-300 lg:border-[1rem] border-[0.8rem]              border-indigo-400 cursor-pointer hover:scale-105 transition-all ease-in hover:border-indigo-600 hover:shadow-2xl"
              data-target="paper"
              onClick={handleUserSelection}
            >
              <img
            ...
            {/* Rock */}
            <div
              className="absolute lg:bottom-[6%] bottom-[10%] lg:right-[20%] right-[12%] lg:w-[160px] lg:h-[160px] w-[100px] h-[100px] flex items-center justify-center rounded-full bg-slate-300 lg:border-[1rem] border-[0.8rem]
            ...
            {/* Lizard */}
            <div
              className="absolute lg:bottom-[6%] bottom-[10%] lg:left-[22%] left-[12%] lg:w-[160px] lg:h-[160px] w-[100px] h-[100px] flex items-center justify-center rounded-full bg-slate-300 lg:border-[1rem] border-[0.8rem] border-fuchsia-400 cursor-pointer hover:scale-105 transition-all ease-in hover:border-fuchsia-600 hover:shadow-2xl"
              data-target="lizard"
              onClick={handleUserSelection}
            >
              <img
            ...
            {/* Spock */}
            <div
              className="absolute lg:top-[26%] top-[32%] lg:left-[15%] left-[3%] lg:w-[160px] lg:h-[160px] w-[100px] h-[100px] flex items-center justify-center rounded-full bg-slate-300 lg:border-[1rem] border-[0.8rem] border-blue-400 cursor-pointer hover:scale-105 transition-all ease-in hover:border-blue-600 hover:shadow-2xl"
              data-target="spock"
              onClick={handleUserSelection}
            >
              <img
          ...
          {/* result container */}
          <div
            className={`w-full lg:h-[310px] bg-gray-800 p-4 lg:px-6 rounded-lg ${
              resultPanel ? "flex" : "hidden"
            } flex-row items-center justify-between shadow-xl`}
          >
            <div className="lg:w-[30%] flex flex-col justify-center items-center gap-4">
